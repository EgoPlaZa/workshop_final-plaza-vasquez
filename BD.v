...
//Date        : Mon Mar  7 18:03:25 2022
//Host        : DESKTOP-B1KIP6Q running 64-bit major release  (build 9200)
...
module BD
  ...
  BD_swerv_wrapper_verilog_0_0 swerv_wrapper_verilog_0
       (.clk(clk_0_1),
        ...
        .nmi_int(syscon_wrapper_0_o_timer_irq),
        ...
        .timer_int(syscon_wrapper_0_o_nmi_int));
